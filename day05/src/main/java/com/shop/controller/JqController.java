...
public class JqController {
	...
	public String registerimpl(Model m,
		...
		m.addAttribute("rnmae",name);
		m.addAttribute("center","jq/registerok");
		m.addAttribute("left","jq/left");
		return "main";	
	}
	/*
	 * @RequestMapping("/registserimpl") public String registserimpl(Model m, String
	 * name, String age, String address, String phone) {
	 * System.out.println(name+""); if(name != null) {
	 * m.addAttribute("registername",name); m.addAttribute("center","jq/register");
	 * } m.addAttribute("left","jq/left"); return "main"; }
	 */
